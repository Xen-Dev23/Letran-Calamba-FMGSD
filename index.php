    ...
    <div class="container mx-auto px-4 py-2 flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
            ...
            <div class="flex items-center space-x-3">
                <a href="login.php" class="bg-blue-800 text-white px-4 py-2 rounded-full font-semibold hover:bg-blue-900 dark:bg-blue-600 dark:hover:bg-blue-700 transition duration-300">LOGIN</a>
...
<section id="home" class="relative h-[700px] text-white overflow-hidden">
    ...
    <div class="container mx-auto px-4 h-full flex items-center justify-center text-center relative z-20">
        <div>
            ...
            <a href="#about" class="bg-yellow-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-yellow-600 dark:bg-yellow-400 dark:hover:bg-yellow-500 transition animate-hero" style="transition-delay: 0.4s;">Explore Now</a>
        </div>
    </div>
</section>
...
<footer>
    ...
    <!-- Middle Section: Dominican Links and International Linkages -->
