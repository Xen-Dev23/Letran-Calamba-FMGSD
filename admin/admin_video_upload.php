...
<body>
			...
			<form class="upload-form" method="POST" enctype="multipart/form-data">
				<div class="pages page-one ">
					...
					<div class="button-section">
						<button type="button" id="next-page-btn" class="page-button">
							Next
						</button>
					</div>
				</div>
				...
				<!-- HIDE AS DEFAULT -->
				<div class="page-two pages button-section hidden">

					<div id="questions-container" class="inputs">
						<div class="question-block" style="margin-bottom: 20px; border: 1px solid #ccc; padding: 10px;">
							<h4>Question 1</h4>
							<textarea name="questions[]" required placeholder="Question text" style="width:100%; height:60px;"></textarea><br>
							<input type="text" name="option_a[]" required placeholder="Option A"><br>
							<input type="text" name="option_b[]" required placeholder="Option B"><br>
							<input type="text" name="option_c[]" required placeholder="Option C"><br>
							<input type="text" name="option_d[]" required placeholder="Option D"><br>
							Correct Answer:
							<select id="correct-option-slc" name="correct_option[]" required>
					...
					<div class="button-section">
						<button type="button" id="previous-page-btn" class="page-button">
							Back
						</button>
	...
	<script>
		...
		const backPageBtn = document.getElementById('previous-page-btn');

		nextPageBtn.addEventListener('click', () => {
			const isPageTwoHides = pageTwo.classList.contains('hidden');
			if (isPageTwoHides) {
		...
		backPageBtn.addEventListener('click', () => {
			const isPageOneHides = pageOne.classList.contains('hidden');
			if (isPageOneHides) {
		...
		function addQuestion() {
			...
			if (totalQuestions >= 50) {
				alert('Maximum of 50 questions only.');
				return;
			}
